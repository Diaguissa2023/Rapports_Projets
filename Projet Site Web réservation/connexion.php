...
<body>
	<div class="text-right">
      <a  class="btn btn-success"href="index.php"><span class="glyphicon glyphicon-home"></span> page d'accueil</a>
    </div>
	
	<div class="text-center">
		Bienvenue! L'inscription à été effectuée avec succès, vous pouvez vous connecter
	</div>
  <form action="connexion.php" method="post" class="login-form container w-50">
