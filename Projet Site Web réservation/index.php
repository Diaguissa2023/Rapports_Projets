...
<html>
    ...
    <body>
        <div class="container">
			...
			<p><i>* Si vous êtes déjà inscrit, ciliquez sur ce lien</i></p>
                <div class="form-group">
                    <button type="submit"><a href="connexion.php">Connexion</a></button>
                 </div>
            <div class="heading">
			        ...
			        <div id="contact-form"  role="form">
					  ...
					  <br>
						<p><i>* Si vous êtes un annonceur, inscrivez-vous sur ce lien ci-dessous</i></p>
                           <div class="form-group">
                               <button type="submit"><a href="admin/login_annonceur.php">Inscription</a></button>
                           </div>
					</div>
                </div>
            </div>
